import 'dart:async';
import 'package:agapecares/features/user_app/features/cart/presentation/widgets/cart_item_card.dart';
...
class _CartPageState extends State<CartPage> {
  ...
  Widget build(BuildContext context) {
    // Use a state-backed controller to avoid recreating it on every build
